...
Para transformar essas descobertas em uma ferramenta de ação, construímos um Modelo Preditivo usando o algoritmo Random Forest. Nosso objetivo era prever se um aluno teria defasagem. A métrica mais importante para a Passos Mágicos é o Recall, a sensibilidade. Precisamos identificar o máximo de alunos em risco real para que a intervenção seja feita. Nosso modelo atingiu 85% de Recall. Isso significa que ele consegue identificar a grande maioria dos alunos que realmente estão em risco. A qualidade global do modelo, medida pelo AUC-ROC, também é alta, em 87%. A Acurácia é de 79% e o F1-Score é de 35%. Mas quais fatores o modelo considerou mais importantes para essa predição?

# 6 - Features Mais Importantes

Vimos que o modelo é robusto, mas o que realmente define o risco de defasagem? A Feature Importance nos mostra quais indicadores são cruciais para a decisão do modelo. O IAN, Adequação ao Nível, é o preditor dominante, respondendo por 38% da decisão. Isso é esperado, pois ele mede a defasagem idade-série diretamente. Mas o modelo não depende só dele. A Média dos Indicadores, o IAA (Autoavaliação) e o IEG (Engajamento) juntos somam mais de 30% da importância. Isso reforça que o desempenho global, a percepção do aluno e o seu engajamento são fatores de risco significativos. O IPS, o fator Psicossocial, também é relevante com 8.6%. Esses insights nos permitem focar as intervenções nos fatores que o modelo considera mais críticos. Agora, vamos ver como a equipe da Passos Mágicos pode usar isso no dia a dia.
